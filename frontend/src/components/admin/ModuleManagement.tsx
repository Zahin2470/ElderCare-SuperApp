...
function ModuleManagementPreview({ module }: ModuleManagementProps) {
...
export function ModuleManagement(props: Parameters<typeof ModuleManagementPreview>[0]) {
  return (
    <>
      <DemoNotice what="This module-management view" />
      <ModuleManagementPreview {...props} />
    </>
  );
}
